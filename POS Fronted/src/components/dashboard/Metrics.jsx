    ...
    <div className='container mx-auto py-2 px-6 md:px-4'>
      <div className="flex justify-between items-center">
        <div className="">
          ...
          <p className='tetx-sm text-[#ababab]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus, vitae. </p>
        </div>
        <button className="flex items-center gap-1 px-4 py-2 rounded-md text-[#f5f5f5] bg-[#1a1a1a]">
          ...
          >
            <path
              d={metricsData.isIncrease ? "M5 15l7-7 7 7" : "M19 9l-7 7-7-7"}
            />
          </svg>
        </button>
      </div>
